...
public:
    SLIC_Algorithm_SoA_Parallel(cv::Mat image_lab, int K, int m, int iterations) {
        ...
        super_pixels->centroid_x = (int*)malloc(this->K * sizeof(int));
        super_pixels->centroid_y = (int*)malloc(this->K * sizeof(int));
        super_pixels->val_L = (float*)malloc(this->K * sizeof(float));
        super_pixels->val_a = (float*)malloc(this->K * sizeof(float));
        super_pixels->val_b = (float*)malloc(this->K * sizeof(float));
        super_pixels->label = (int*)malloc(this->K * sizeof(int));
